...
//
//  Created by Abanoub Ashraf on 05/02/2023.
//

import SwiftUI

///
/// identifiable -> so we can loop it through an id
///
...
var featuredCourses = [
    ...
    Course(
        ...
        image: "Illustration 1", background: "Background 1",
        logo: "Logo 1"
    ),
    Course(
        ...
        image: "Illustration 2", background: "Background 2",
        logo: "Logo 3"
    )
]
